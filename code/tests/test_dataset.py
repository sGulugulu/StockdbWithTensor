...
class DatasetTests(unittest.TestCase):
    ...
    def test_build_tensor_dataset(self) -> None:
        ...
        self.assertEqual(dataset.preprocess_summary["fill_strategy"], "forward_backward_industry_median")
        self.assertEqual(dataset.preprocess_summary["standardize_method"], "winsorize_zscore")
        self.assertEqual(dataset.preprocess_summary["filtered_stock_count"], 4)
